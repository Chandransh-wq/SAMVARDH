...
import { createSubject, createTopic } from "../sources/notebookServices";
...
const CreateTopicForm: React.FC<CreateTopicFormProps> = ({ darkMode, id, setOpen, subjectId }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const created = await createTopic(newTopic, id, subjectId);
